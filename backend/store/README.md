...
mvnw -ntp org.jacoco:jacoco-maven-plugin:prepare-agent initialize sonar:sonar -Dsonar.host.url=http://localhost:9000 -Dsonar.login=sqa_031d4e848a773ffbd68560f737e6096e61c5e9e9 -Dmaven.repo.local=.maven

docker run -d --name sonarqube -p 9000:9000 -e SONAR_WEB_HOST=0.0.0.0 sonarqube
...
docker build -t registry.local:7777/store/store:1.0 .
docker push registry.local:7777/store/store:1.0
