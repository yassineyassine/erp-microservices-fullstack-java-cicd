...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.soft.erp.store.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.soft.erp.store.security.DomainUserDetailsService", "createSpringSecurityUser");
