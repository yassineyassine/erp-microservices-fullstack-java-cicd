...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.soft.erp.invoice.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.soft.erp.invoice.security.DomainUserDetailsService", "createSpringSecurityUser");
