package com.soft.erp.product.config;
...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.soft.erp.product.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.soft.erp.product.security.DomainUserDetailsService", "createSpringSecurityUser");
