...
utiliser le même clé secrité pour toutes les service, modifier 

#docker
Desactiver docker dans fihcier application.properties
./mvnw -Dspring.docker.compose.enabled=false -DskipTests -DskipDocker package
./mvnw -Pdev spring-boot:run -DskipTests
...
To build the final jar and optimize the erp2 application for production, run:
